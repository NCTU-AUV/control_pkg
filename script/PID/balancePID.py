...
class Balance():
	...
	def Main(self):
		...
		while not rospy.is_shutdown():
			...
			if self.state == 1 or self.state == 2:
				...
				R = AUV_physics.eulerAnglesToRotationMatrix(self.altitude)
	...
	def balance_cb(self,data):
		self.altitude[0]=data.data[0]*math.pi/180.
		self.altitude[1]=data.data[1]*math.pi/180.
		#self.altitude[2]=data.data[2]*math.pi/180.
		self.altitude[2]=0
